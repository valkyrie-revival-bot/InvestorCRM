    ...
    3. Create `components/investors/investor-kanban-board.tsx`:
       ...
       - handleDragEnd implementation:
         ...
         e. If stage changed (source.droppableId !== destination.droppableId):
            ...
            - On success: show toast.success(`Moved to ${destination.droppableId}`)
...
8. Empty stage columns show "No investors in this stage"
9. Board horizontally scrolls to show all 12 stage columns
10. Applying filters in the filter bar reduces cards shown in kanban
11. Searching reduces cards shown in kanban
</verification>
