 ...
 * Sent when a task is due in 24h or 1h
 */
...
export const TaskReminderEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Task reminder: {taskTitle} is due {timeUntilDue}</Preview>
      <Body style={main}>
...
TaskReminderEmail.PreviewProps = {
  ...
  dueDateFormatted: 'February 15, 2026 at 10:00 AM',
  timeUntilDue: 'in 24 hours',
  priority: 'high' as const,
  investorName: 'Sequoia Capital',
  taskUrl: 'http://localhost:3003/tasks',
} as TaskReminderEmailProps;
